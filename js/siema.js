          ...
          , l = function() {
            ...
            return s(e, [{
                ...
                value: function(e) {
                    ...
                    t.style.width = (this.config.loop ? 100 / (this.innerElements.length + 2 * this.perPage) : 100 / this.innerElements.length) - 1 + "%",
                    t.appendChild(e),
                    t
                }
            }, {
                ...
                value: function(e) {
                    var t = this
                      ...
                      , r = (this.config.rtl ? 1 : -1) * i * (this.selectorWidth / this.perPage + 12);
                      $('.work__btn').removeClass('work__btn_active');
                      $('.work__btn').eq(i).addClass('work__btn_active');
